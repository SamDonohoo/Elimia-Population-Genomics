setwd("C:/Users/pred9/Desktop/AU_PhD/Auburn Stuff/2DRad-Ebell-Ecoc/2024_Jan_Redos/FSC2/Eaffbella/")
...
mod1 <- read.table("Eaffbella_Constant_Multi.bestlhoods", header = TRUE)
mod2 <- read.table("Eaffbella_Growth_Multi.bestlhoods", header = TRUE)
mod3 <- read.table("Eaffbella_Bottle1_Multi.bestlhoods", header = TRUE)
mod4 <- read.table("Eaffbella_Bottle1Inst_Multi.bestlhoods", header = TRUE)
mod5 <- read.table("Eaffbella_Bottle1Growth_Multi.bestlhoods", header = TRUE)
mod6 <- read.table("Eaffbella_Bottle2_Multi.bestlhoods", header = TRUE)
mod7 <- read.table("Eaffbella_Bottle2Inst_Multi.bestlhoods", header = TRUE)
mod8 <- read.table("Eaffbella_Bottle2Growth_Multi.bestlhoods", header = TRUE)
...
mod1[13,]$MaxEstLhood - mod1[1,]$MaxObsLhood # difference between MaxEst and MaxObs
...
bootbs <- read.table('EaffbellaBottle1_Bootstrapping.bestlhoods', header = TRUE) # Read in ML nonparametric bootstrapped parameters following 50 runs for each simulated SFS
