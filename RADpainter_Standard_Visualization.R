...
setwd("C:/Users/pred9/Desktop/AU_PhD/Auburn Stuff/2DRad-Ebell-Ecoc/2024_Jan_Redos/RADpainter/Bellacrenata/")


### 1) EDIT THE FOLLOWING THREE LINES TO PROVIDE PATHS TO THE fineRADstructure OUTPUT 

chunkfile<-"Ebella_2.80.025.50_Multi.haps_chunks.out" ## RADpainter output file
mcmcfile<-"Ebella_2.80.025.50_Multi.haps_chunks.mcmc.xml" ## finestructure mcmc file
treefile<-"Ebella_2.80.025.50_Multi.haps_chunks.mcmcTree.xml" ## finestructure tree file
### 2) EDIT THIS PATH TO WHERE YOU WANT THE PLOTS:
plotsFolder <- "RADpainter_R_Plots/"
### 3) SET VALUES FOR THESE VARIABLES: "analysisName" will be included in output plots
analysisName <- "populations.haps";  maxIndv <- 1000; maxPop<-1000
