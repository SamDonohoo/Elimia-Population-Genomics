setwd("C:/Users/pred9/Desktop/AU_PhD/Auburn Stuff/2DRad-Ebell-Ecoc/2024_Jan_Redos/FSC2/EspTanne/")
...
mod1 <- read.table("EspTanne_Constant_Multi.bestlhoods", header = TRUE)
mod2 <- read.table("EspTanne_Growth_Multi.bestlhoods", header = TRUE)
mod3 <- read.table("EspTanne_Bottle1_Multi.bestlhoods", header = TRUE)
mod4 <- read.table("EspTanne_Bottle1Inst_Multi.bestlhoods", header = TRUE)
mod5 <- read.table("EspTanne_Bottle1Growth_Multi.bestlhoods", header = TRUE)
mod6 <- read.table("EspTanne_Bottle2_Multi.bestlhoods", header = TRUE)
mod7 <- read.table("EspTanne_Bottle2Inst_Multi.bestlhoods", header = TRUE)
mod8 <- read.table("EspTanne_Bottle2Growth_Multi.bestlhoods", header = TRUE)
...
mod1[4,]$MaxEstLhood - mod1[1,]$MaxObsLhood # difference between MaxEst and MaxObs
...
bootbs <- read.table('EspTanneBottle1_Bootstrapping.bestlhoods', header = TRUE) # Read in ML nonparametric bootstrapped parameters following 50 runs for each simulated SFS
